 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type CourseListDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<CourseListDocumentData>, "course_list", Lang>;
...
type HomePageDocumentDataSlicesSlice = CourseListSlice | TeamCardsSectionSlice | ThreeColumnExplainerSlice | ColumnCardsSlice | SplitFeatureBlockSlice | HorizontalSliceSlice | FiftyFiftySlice | HeroSlice
...
type PageDocumentDataSlicesSlice = CourseListSlice | FiftyFiftySlice | HorizontalSliceSlice | ThreeColumnExplainerSlice | TeamCardsSectionSlice | SplitFeatureBlockSlice | ColumnCardsSlice | HeroSlice
...
export type AllDocumentTypes = CategoryDocument | CourseListDocument | GlobalNavigationDocument | HomePageDocument | PageDocument;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type CourseListSliceDefault = prismic.SharedSliceVariation<"default", Simplify<CourseListSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type CourseListSlice = prismic.SharedSlice<"course_list", CourseListSliceVariation>;
...
export interface FiftyFiftySliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	background_color: prismic.SelectField<"primary" | "white" | "secondary" | "gradient", "filled">;
