...
export interface CourseListingDocumentDataCoursesItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	minimum_technology: prismic.SelectField<"Computer" | "Mobile" | "Computer and Mobile">;
}
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type CourseListingDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<CourseListingDocumentData>, "course_listing", Lang>;
...
export interface FooterDocumentDataSocialLinksItem {
	...
	/**
	 * Link field in *Footer → Social_Links*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type GlobalNavigationDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<GlobalNavigationDocumentData>, "global_navigation", Lang>;

type HomePageDocumentDataSlicesSlice = TestimonialsSlice | NumberedCardSectionSlice | ExplainerSlice | BasicTextBlockSlice | CourseListingSlice | TeamCardsSectionSlice | ThreeColumnExplainerSlice | ColumnCardsSlice | SplitFeatureBlockSlice | HorizontalSliceSlice | FiftyFiftySlice | HeroSlice
...
type PageDocumentDataSlicesSlice = NumberedCardSectionSlice | TestimonialsSlice | BasicTextBlockSlice | ExplainerSlice | CourseListingSlice | FiftyFiftySlice | HorizontalSliceSlice | ThreeColumnExplainerSlice | TeamCardsSectionSlice | SplitFeatureBlockSlice | ColumnCardsSlice | HeroSlice
...
export type AllDocumentTypes = CategoryDocument | CourseListingDocument | FooterDocument | GlobalNavigationDocument | HomePageDocument | PageDocument;
...
export interface BasicTextBlockSliceBlockLeftAlignedPrimaryButtonGroupItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	button_variation: prismic.SelectField<"solid" | "outline" | "ghost" | "link", "filled">;
}
...
export interface BasicTextBlockSliceBlockLeftAlignedPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	backgroundcolor: prismic.SelectField<"white" | "primary" | "secondary" | "gradient" | "swoosh", "filled">;
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<BasicTextBlockSliceBlockLeftAlignedPrimaryButtonGroupItem>>;
}
 ...
 */
export type BasicTextBlockSliceBlockLeftAligned = prismic.SharedSliceVariation<"blockLeftAligned", Simplify<BasicTextBlockSliceBlockLeftAlignedPrimary>, never>;
...
export interface BasicTextBlockSliceBlockCenterAlignedPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<BasicTextBlockSliceBlockCenterAlignedPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BasicTextBlockSliceBlockCenterAligned = prismic.SharedSliceVariation<"blockCenterAligned", Simplify<BasicTextBlockSliceBlockCenterAlignedPrimary>, never>;

/**
 * Slice variation for *BasicTextBlock*
 */
type BasicTextBlockSliceVariation = BasicTextBlockSliceBlockLeftAligned | BasicTextBlockSliceBlockCenterAligned
...
export interface ColumnCardsSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<ColumnCardsSliceDefaultPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ColumnCardsSliceDefault = prismic.SharedSliceVariation<"default", Simplify<ColumnCardsSliceDefaultPrimary>, never>;
...
export interface ColumnCardsSliceFourColumnPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	cards: prismic.GroupField<Simplify<ColumnCardsSliceFourColumnPrimaryCardsItem>>;
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<ColumnCardsSliceFourColumnPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ColumnCardsSliceFourColumn = prismic.SharedSliceVariation<"fourColumn", Simplify<ColumnCardsSliceFourColumnPrimary>, never>;
...
export interface ColumnCardsSliceTwoColumnPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	cards: prismic.GroupField<Simplify<ColumnCardsSliceTwoColumnPrimaryCardsItem>>;
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<ColumnCardsSliceTwoColumnPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ColumnCardsSliceTwoColumn = prismic.SharedSliceVariation<"twoColumn", Simplify<ColumnCardsSliceTwoColumnPrimary>, never>;

/**
 * Slice variation for *ColumnCards*
 */
type ColumnCardsSliceVariation = ColumnCardsSliceDefault | ColumnCardsSliceFourColumn | ColumnCardsSliceTwoColumn
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ColumnCardsSlice = prismic.SharedSlice<"column_cards", ColumnCardsSliceVariation>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type CourseListingSliceDefault = prismic.SharedSliceVariation<"default", Simplify<CourseListingSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type CourseListingSlice = prismic.SharedSlice<"course_listing", CourseListingSliceVariation>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExplainerSliceDefault = prismic.SharedSliceVariation<"default", Simplify<ExplainerSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExplainerSlice = prismic.SharedSlice<"explainer", ExplainerSliceVariation>;
...
export interface FiftyFiftySliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	background_color: prismic.SelectField<"white" | "primary" | "secondary" | "gradient" | "swoosh", "filled">;
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<FiftyFiftySliceDefaultPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type FiftyFiftySliceDefault = prismic.SharedSliceVariation<"default", Simplify<FiftyFiftySliceDefaultPrimary>, never>;
...
export interface FiftyFiftySliceFiftyFiftyRightAlignedPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<FiftyFiftySliceFiftyFiftyRightAlignedPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type FiftyFiftySliceFiftyFiftyRightAligned = prismic.SharedSliceVariation<"fiftyFiftyRightAligned", Simplify<FiftyFiftySliceFiftyFiftyRightAlignedPrimary>, never>;

/**
 * Slice variation for *FiftyFifty*
 */
type FiftyFiftySliceVariation = FiftyFiftySliceDefault | FiftyFiftySliceFiftyFiftyRightAligned
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type FiftyFiftySlice = prismic.SharedSlice<"fifty_fifty", FiftyFiftySliceVariation>;

/**
 * Item in *Footer → Default → Primary → AboutColumn*
 */
export interface FooterSliceDefaultPrimaryAboutcolumnItem {
	/**
	 * Name field in *Footer → Default → Primary → AboutColumn*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.aboutcolumn[].name
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	name: prismic.KeyTextField;
	
	/**
	 * Link field in *Footer → Default → Primary → AboutColumn*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.aboutcolumn[].link
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
	link: prismic.LinkField;
}
...
/**
 * Item in *Footer → Default → Primary → ProgramsColumn*
 */
export interface FooterSliceDefaultPrimaryProgramscolumnItem {
	/**
	 * Name field in *Footer → Default → Primary → ProgramsColumn*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.programscolumn[].name
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	name: prismic.KeyTextField;
	
	/**
	 * Link field in *Footer → Default → Primary → ProgramsColumn*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.programscolumn[].link
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
	link: prismic.LinkField;
}
...
/**
 * Item in *Footer → Default → Primary → VolunteerColumn*
 */
export interface FooterSliceDefaultPrimaryVolunteercolumnItem {
	/**
	 * Name field in *Footer → Default → Primary → VolunteerColumn*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.volunteercolumn[].name
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	name: prismic.KeyTextField;
	
	/**
	 * Link field in *Footer → Default → Primary → VolunteerColumn*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.volunteercolumn[].link
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
	link: prismic.LinkField;
}
...
export interface FooterSliceDefaultPrimary {
	/**
	 * AboutColumn field in *Footer → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.aboutcolumn[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	aboutcolumn: prismic.GroupField<Simplify<FooterSliceDefaultPrimaryAboutcolumnItem>>;
	
	/**
	 * ProgramsColumn field in *Footer → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.programscolumn[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	programscolumn: prismic.GroupField<Simplify<FooterSliceDefaultPrimaryProgramscolumnItem>>;
	
	/**
	 * VolunteerColumn field in *Footer → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.default.primary.volunteercolumn[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	volunteercolumn: prismic.GroupField<Simplify<FooterSliceDefaultPrimaryVolunteercolumnItem>>;
}
...
export interface HeroSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<HeroSliceDefaultPrimaryButtonGroupItem>>;
}
...
export interface HeroSliceHero5050LeftAlignedPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<HeroSliceHero5050LeftAlignedPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSliceHero5050LeftAligned = prismic.SharedSliceVariation<"hero5050LeftAligned", Simplify<HeroSliceHero5050LeftAlignedPrimary>, never>;
...
export interface HeroSliceHero5050RightAlignedPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<HeroSliceHero5050RightAlignedPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSliceHero5050RightAligned = prismic.SharedSliceVariation<"hero5050RightAligned", Simplify<HeroSliceHero5050RightAlignedPrimary>, never>;
...
export interface HeroSlicePageHeaderBlockLeftAlignedPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<HeroSlicePageHeaderBlockLeftAlignedPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSlicePageHeaderBlockLeftAligned = prismic.SharedSliceVariation<"pageHeaderBlockLeftAligned", Simplify<HeroSlicePageHeaderBlockLeftAlignedPrimary>, never>;
...
export interface HeroSlicePageHeaderBlockCenteredPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<HeroSlicePageHeaderBlockCenteredPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSlicePageHeaderBlockCentered = prismic.SharedSliceVariation<"pageHeaderBlockCentered", Simplify<HeroSlicePageHeaderBlockCenteredPrimary>, never>;

/**
 * Slice variation for *Hero*
 */
type HeroSliceVariation = HeroSliceDefault | HeroSliceHero5050LeftAligned | HeroSliceHero5050RightAligned | HeroSlicePageHeaderBlockLeftAligned | HeroSlicePageHeaderBlockCentered
...
export interface HorizontalSliceSliceLeftImagePrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<HorizontalSliceSliceLeftImagePrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HorizontalSliceSliceLeftImage = prismic.SharedSliceVariation<"leftImage", Simplify<HorizontalSliceSliceLeftImagePrimary>, never>;
...
export interface HorizontalSliceSliceRightImagePrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<HorizontalSliceSliceRightImagePrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HorizontalSliceSliceRightImage = prismic.SharedSliceVariation<"rightImage", Simplify<HorizontalSliceSliceRightImagePrimary>, never>;

/**
 * Slice variation for *HorizontalSlice*
 */
type HorizontalSliceSliceVariation = HorizontalSliceSliceLeftImage | HorizontalSliceSliceRightImage
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HorizontalSliceSlice = prismic.SharedSlice<"horizontal_slice", HorizontalSliceSliceVariation>;
...
export interface NavigationSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	child_navigation: prismic.GroupField<Simplify<NavigationSliceDefaultPrimaryChildNavigationItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type NavigationSliceDefault = prismic.SharedSliceVariation<"default", Simplify<NavigationSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type NavigationSliceNavigationSingleLink = prismic.SharedSliceVariation<"navigationSingleLink", Simplify<NavigationSliceNavigationSingleLinkPrimary>, never>;

/**
 * Slice variation for *Navigation*
 */
type NavigationSliceVariation = NavigationSliceDefault | NavigationSliceNavigationSingleLink
...
export interface NumberedCardSectionSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	numbered_cards: prismic.GroupField<Simplify<NumberedCardSectionSliceDefaultPrimaryNumberedCardsItem>>;
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	button_group: prismic.GroupField<Simplify<NumberedCardSectionSliceDefaultPrimaryButtonGroupItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type NumberedCardSectionSliceDefault = prismic.SharedSliceVariation<"default", Simplify<NumberedCardSectionSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type NumberedCardSectionSlice = prismic.SharedSlice<"numbered_card_section", NumberedCardSectionSliceVariation>;
...
export interface SplitFeatureBlockSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	split_feature_block: prismic.GroupField<Simplify<SplitFeatureBlockSliceDefaultPrimarySplitFeatureBlockItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SplitFeatureBlockSliceDefault = prismic.SharedSliceVariation<"default", Simplify<SplitFeatureBlockSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SplitFeatureBlockSlice = prismic.SharedSlice<"split_feature_block", SplitFeatureBlockSliceVariation>;
...
export interface TeamCardsSectionSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	grid: prismic.GroupField<Simplify<TeamCardsSectionSliceDefaultPrimaryGridItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TeamCardsSectionSliceDefault = prismic.SharedSliceVariation<"default", Simplify<TeamCardsSectionSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TeamCardsSectionSlice = prismic.SharedSlice<"team_cards_section", TeamCardsSectionSliceVariation>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ThemingSliceDefault = prismic.SharedSliceVariation<"default", Record<string, never>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ThemingSlice = prismic.SharedSlice<"theming", ThemingSliceVariation>;
...
export interface ThreeColumnExplainerSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	multi_column_explainer: prismic.GroupField<Simplify<ThreeColumnExplainerSliceDefaultPrimaryMultiColumnExplainerItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ThreeColumnExplainerSliceDefault = prismic.SharedSliceVariation<"default", Simplify<ThreeColumnExplainerSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ThreeColumnExplainerSlice = prismic.SharedSlice<"three_column_explainer", ThreeColumnExplainerSliceVariation>;
...
declare module "@prismicio/client" {
	...
	namespace Content {
		export type {
			...
			FooterSlice,
			FooterSliceDefaultPrimaryAboutcolumnItem,
			FooterSliceDefaultPrimaryProgramscolumnItem,
			FooterSliceDefaultPrimaryVolunteercolumnItem,
